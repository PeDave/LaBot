...
namespace LaBot.Exchanges.Bitget.Adapters;

public class BitgetAdapter : IExchangeAdapter
{
    ...
    public BitgetAdapter(string apiKey, string apiSecret, string? passphrase = null, bool isTestnet = false)
    {
        _apiKey = apiKey;
