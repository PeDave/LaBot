...
namespace LaBot.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BotInstances_Tenants_TenantId",
                        column: x => x.TenantId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Passphrase = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExchangeApiKeys", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExchangeApiKeys_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WalletSnapshots_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    BotInstanceId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BotStates_BotInstances_BotInstanceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Signals_BotInstances_BotInstanceId",
                        column: x => x.BotInstanceId,
                        principalTable: "BotInstances",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BotInstances_TenantId_Name",
                table: "BotInstances",
                columns: new[] { "TenantId", "Name" });

            migrationBuilder.CreateIndex(
                name: "IX_BotStates_BotInstanceId_Timestamp",
                table: "BotStates",
                columns: new[] { "BotInstanceId", "Timestamp" });

            migrationBuilder.CreateIndex(
                name: "IX_Candles_Symbol_ExchangeName_Interval_OpenTime",
                table: "Candles",
                columns: new[] { "Symbol", "ExchangeName", "Interval", "OpenTime" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ExchangeApiKeys_TenantId_ExchangeName",
                table: "ExchangeApiKeys",
                columns: new[] { "TenantId", "ExchangeName" });

            migrationBuilder.CreateIndex(
                name: "IX_Signals_BotInstanceId_CreatedAt",
                table: "Signals",
                columns: new[] { "BotInstanceId", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletSnapshots_TenantId_SnapshotTime",
                table: "WalletSnapshots",
                columns: new[] { "TenantId", "SnapshotTime" });
        }
